...
import { __toESM, require_react } from "./react-zGp3Izgd.js";
...
function getScriptSrc(props) {
	...
	if (props.basePath) return `${props.basePath}/speed-insights/script.js`;
...
function injectSpeedInsights(props = {}) {
	...
	if (props.sampleRate) script.dataset.sampleRate = props.sampleRate.toString();
	if (props.route) script.dataset.route = props.route;
	if (props.endpoint) script.dataset.endpoint = props.endpoint;
	else if (props.basePath) script.dataset.endpoint = `${props.basePath}/speed-insights/vitals`;
...
function SpeedInsights(props) {
	...
	(0, import_react.useEffect)(() => {
		...
		} else if (props.route) setScriptRoute.current(props.route);
	}, [props.route]);
	return null;
}
